    ...
    <nav className="topnav">
      ...
      <div className="nav-right">
        ...
        <div className="profile-wrapper">
          ...
          >
            <span className="avatar">{initials[0]}</span>

            {/* Full name visible on large screens */}
            <span className="username full-name">{username}</span>

            {/* Initials visible on small screens */}
            <span className="username initials-only">{initials}</span>
          </button>
